...
class _$TodoItemDtoTearOff {
  ...
  _TodoItemDto call(
      {@required String id, @required String title, @required bool isDone}) {
    return _TodoItemDto(
      id: id,
      title: title,
      isDone: isDone,
...
class _$_TodoItemDto extends _TodoItemDto with DiagnosticableTreeMixin {
  ...
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'TodoItemDto(id: $id, title: $title, isDone: $isDone)';
  }
...
abstract class $NoteDtoCopyWith<$Res> {
  ...
  $Res call(
      ...
      @ServerTimeStameCOnverter() FieldValue serverTimeStamp});
}
...
class _$_NoteDto extends _NoteDto with DiagnosticableTreeMixin {
  const _$_NoteDto(
      ...
      @required this.color,
      @required this.todos,
      @required @ServerTimeStameCOnverter() this.serverTimeStamp})
      : assert(body != null),
        assert(color != null),
        assert(todos != null),
