...
abstract class $NoteCopyWith<$Res> {
  ...
  $Res call(
      {UniqeId id, NoteBody body, NoteColor color, NoteList<TodoItem> todos});
}
...
class _$NoteCopyWithImpl<$Res> implements $NoteCopyWith<$Res> {
  ...
  $Res call({
    ...
    return _then(_value.copyWith(
      ...
      todos: todos == freezed ? _value.todos : todos as NoteList<TodoItem>,
    ));
  }
}
...
abstract class _Note extends Note {
  ...
  const factory _Note(
      ...
      @required NoteBody body,
      @required NoteColor color,
      @required NoteList<TodoItem> todos}) = _$_Note;
